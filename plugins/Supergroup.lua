...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "\n⚙تنظیمات سوپرگروپ⚙:\n____________________\n⚡️قفل لینک ها : "..settings.lock_link.."\n⚡️قفل شماره ها: "..settings.lock_contacts.."\n⚡️قفل فلود: "..settings.flood.."\n⚡️حساسیت فلود : "..NUM_MSG_MAX.."\n⚡️قفل اسپم: "..settings.lock_spam.."\n⚡️قفل عربی: "..settings.lock_arabic.."\n⚡️قفل اعضا: "..settings.lock_member.."\n⚡️قفل آرتی ال: "..settings.lock_rtl.."\n⚡️قفل قابلیت های تلگرام: "..settings.lock_tgservice.."\n⚡قفل استیکر: "..settings.lock_sticker.."\n⚡️قفل تگ: "..settings.tag.."\n⚡️قفل شکلک ها: "..settings.emoji.."\n⚡️قفل انگلیسی: "..settings.english.."\n⚡️قفل فروارد: "..settings.fwd.."\n⚡️قفل ریپلای: "..settings.reply.."\n⚡️قفل جوین: "..settings.join.."\n⚡️قفل نام کاربری: "..settings.username.."\n⚡️قفل مدیا: "..settings.media.."\n⚡️قفل فحش: "..settings.fosh.."\n⚡️قفل لیو : "..settings.leave.."\n⚡️قفل ربات ها: "..bots_protection.."\n⚡️قفل اپراتور: "..settings.operator.."\n____________________\n⚙تنظیمات راحت و سریع سوییچ ها⚙:️\n____________________\n⚡️ سوییچ اتحاد: "..settings.etehad.."\n⚡️قفل همه: "..settings.all.."\n____________________\nℹ️درباره گروهℹ️:️\n____________________\n⚡️ نوع گروه: "..gp_type.."\n⚡️عمومی: "..settings.public.."\n⚡️تنظیمات محدودیت: "..settings.strict.."\n____________________\n💥ورژن بات : 2.0 💥\n💥بات سودو💥\n@SuDo_TM"
  return text
end
