...
local function run(msg, matches)
  ...
  local url = "http://assets.imgix.net/examples/redleaf.jpg?blur=120&w=700&h=400&fit=crop&txt="..lionteam.."&txtsize="..size.."&txtclr="..f.."&txtalign=middle,center&txtfont=Futura%20Condensed%20Medium&mono=ff6598cc=?markscale=60&markalign=center%2Cdown&mark64=aHR0cDovL3V1cGxvYWQuaXIvZmlsZXMva3drN19zcGVjdHJlbG9nby5wbmcK"
  local ext = ".webp"
