...
VOLUNTARYCHECK=0
I=1
BOT=SignalTG  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m                    by Sudo Team / @FireBlackHat                 \e[00;37;40m"
echo ""
cat << EOF
...
echo ""
echo -e "\033[38;5;208m @SudoTM-----SudoTM\033[0;00m"
echo -e "\033[38;5;208m @SudoTM-----SudoTM \033[0;00m"
echo -e "\033[38;5;208m @SudoTM-----SudoTM \033[0;00m"
echo -e "\033[38;5;208m @SudoTM-----SudoTM \033[0;00m"
echo -e "\033[38;5;208m @SudoTM-----SudoTM \033[0;00m"
...
EOF
echo -e "                \e[100m                Sudo script           \e[00;37;40m"
echo -e "               \e[01;34m                    by SudoTM                 \e[00;37;40m"
echo ""
cat << EOF
 $bld$f1▄ ▀▄   ▄▀ ▄   $f2 ▄▄▄████▄▄▄    $f3  ▄██▄     $f4▄ ▀▄   ▄▀ ▄   $f5 ▄▄▄████▄▄▄    $f6  ▄██▄  $rst
 $bld$f1█▄█▀███▀█▄█   $f2███▀▀██▀▀███   $f3▄█▀██▀█▄   $f4█▄█▀███▀█▄█   $f5███▀▀██▀▀███   $f6▄█▀██▀█▄$rst
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v2 SudoTM 2016" >&2
	echo ""
	echo -e "\e[0m"
